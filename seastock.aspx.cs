...
public partial class seastock : System.Web.UI.Page
{
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        using (SqlConnection Con = new SqlConnection(ConfigurationManager.ConnectionStrings["FINS"].ConnectionString))
        {
            ...
            Con.Open();
            dt = new DataTable();
            cmd.CommandText = "Insert into Stock (Prod_name,Prod_Qty,Price,Prod_category)values ('" + txtprod_name.Text.ToString() + "','" + txtprod_qty.Text.ToString() + "','" + txtprice.Text.ToString() + "','" + DropDownList1.Text.ToString() + "')";
            cmd.Connection = Con;
            cmd.ExecuteNonQuery();
            DataShow();
